...
const runtimeEntry = path.resolve(sourceDirectory, `../../packages/motionly-runtime/index${ext}`);
const runtimeTypesEntry = path.resolve(sourceDirectory, `../../packages/motionly-runtime/types${ext}`);
const presetsEntry = path.resolve(sourceDirectory, `../../packages/motionly-runtime/presets${ext}`);
